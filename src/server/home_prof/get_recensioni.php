...
$query="SELECT r.id,u.nome as utente, testo, dat FROM recensioni_professori r JOIN utenti u ON r.id_utente=u.id  where r.id_professore=$1 ORDER BY dat DESC DESC";
