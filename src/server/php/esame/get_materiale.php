...
$query="SELECT m.id,u.nome AS utente,u.foto, nomefile,id_utente, dat FROM materiale_didattico m JOIN utenti u ON m.id_utente=u.id where esame=$1 ORDER BY dat DESC";
