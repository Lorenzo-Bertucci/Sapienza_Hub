...
<head>
    ...
    <title>Antonella Poggi - SapienzHub</title>
...
<body>
    <div class="container">
        ...
        <div class="main">
            ...
            <div class="desc">
                <h1>Antonella Poggi</h1>
                <p>
                    <strong>E-mail</strong>: <a href="mailto:antonella.poggi@uniroma1.it" style="color: black;">antonella.poggi@uniroma1.it</a>
                    <br>
                    <strong>Dipartimento</strong>: INGEGNERIA INFORMATICA, AUTOMATICA E GESTIONALE "ANTONIO RUBERTI"
                    <br>
                    <strong>SSD</strong>: ING-INF/05
                    <br>
                    <a href="https://corsidilaurea.uniroma1.it/user/29668" style="color: black;" target="_blank">
        ...
        <div class="content">
            <div class="esami">
                ...
                <div class="card">
                    <a>
                        <h3>Fondamenti di intelligenza artificiale e gestione dei dati</h3>
                        <p>~Scienze matematiche per l'intelligenza artificiale</p>
                    </a>
                </div>
                <div class="card">
                    <a>
                        <h3>Large-scale data management</h3>
