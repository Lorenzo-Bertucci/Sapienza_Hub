...
<head>
    ...
    <title>Marco Schearf - SapienzHub</title>
    ...
    <div class="container">
        ...
        <div class="main">
            ...
            <div class="desc">
                <h1>Marco Schearf</h1>
                <p>
                    <strong>E-mail</strong>: <a href="mailto:marco.schearf@uniroma1.it" style="color: black;">marco.schearf@uniroma1.it</a>
                    <br>
                    <strong>Dipartimento</strong>: INGEGNERIA INFORMATICA, AUTOMATICA E GESTIONALE "ANTONIO RUBERTI"
                    <br>
                    <strong>SSD</strong>: INF-05/A
                    <br>
                    <a href="https://corsidilaurea.uniroma1.it/user/1101" style="color: black;" target="_blank">
